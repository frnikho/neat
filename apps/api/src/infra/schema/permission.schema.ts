...
export const mapPermissionOption = (row: Option<Permission>) =>
  mapOption(row, mapPermission);
export const mapPermissions = (rows: Permission[]) =>
  rows.map((r) => mapPermission(r));
